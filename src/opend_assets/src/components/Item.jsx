...
function Item(props) {
  ...
  const [shouldDisply,setDisplay]=useState(true);
  const id=props.id;
  ...
  async function loadNFT(){
    ...
    const image = URL.createObjectURL(new Blob([imageContent.buffer],{type:"inage/png"}));
  ...
  function handleSell(){
    ...
    setButton(<Button handleClick={sellItem} text={"Confirme"}/>)
